/**
 * netdb.h - Network database operations for PS Vita
 *
 * This header provides POSIX-compatible getaddrinfo/freeaddrinfo/gai_strerror
 * using Vita's native sceNetResolver APIs.
 *
 * Install this to $VITASDK/arm-vita-eabi/include/netdb.h
 */
...
/* NI flags (for getnameinfo, not implemented but defined for compatibility) */
...
/**
 * Resolve hostname to address (POSIX)
 *
...
/**
 * Free addrinfo linked list (POSIX)
 */
void freeaddrinfo(struct addrinfo *res);

/**
 * Get error string for EAI_* error code (POSIX)
 */
